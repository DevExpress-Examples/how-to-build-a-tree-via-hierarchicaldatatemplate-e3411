...
Namespace HierarchicalDataTemplateMode
	...
	Public Class ProjectObject
		...
		Public Sub New()
			...
			AddHandler Stages.CollectionChanged, Function(s, e) AnonymousMethod1(s, e)
		End Sub
	...
	Public Class ProjectStage
		...
		Public Sub New()
			...
			AddHandler Tasks.CollectionChanged, Function(s, e) AnonymousMethod2(s, e)
		End Sub
		...
		Public Shared ReadOnly Property DataSource() As List(Of State)
			Get
				If src Is Nothing Then
					...
					src.Add(New State() With {.TextValue = "Not started", .StateValue = 0, .Image = New BitmapImage(New Uri("/HierarchicalDataTemplateMode.SL;component/Images/State_NotStarted.png", UriKind.Relative))})
					src.Add(New State() With {.TextValue = "In progress", .StateValue = 1, .Image = New BitmapImage(New Uri("/HierarchicalDataTemplateMode.SL;component/Images/State_InProgress.png", UriKind.Relative))})
					src.Add(New State() With {.TextValue = "Completed", .StateValue = 2, .Image = New BitmapImage(New Uri("/HierarchicalDataTemplateMode.SL;component/Images/State_Completed.png", UriKind.Relative))})
				End If
				Return src
			End Get
		End Property
